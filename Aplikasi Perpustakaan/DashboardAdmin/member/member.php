    ...
    <div class="p-4 mt-5">
     ...
     <form action="" method="post" class="mt-5">
      ...
      <div class="table-responsive mt-3">
        ...
        <thead class="text-center">
          <tr>
            ...
            <th class="bg-primary text-light" style="border: 1px solid black;">Kode</th>
            <th class="bg-primary text-light" style="border: 1px solid black;">Nama</th>
            <th class="bg-primary text-light" style="border: 1px solid black;">Jenis Kelamin</th>
            ...
            <th class="bg-primary text-light" style="border: 1px solid black;">No Telepon</th>
            <th class="bg-primary text-light" style="border: 1px solid black;">Pendaftaran</th>
      ...
      <tr>
        ...
        <td style="border: 1px solid black;"><?=$item["kode_member"];?></td>
        <td style="border: 1px solid black;"><?=$item["nama"];?></td>
        <td style="border: 1px solid black;"><?=$item["jenis_kelamin"];?></td>
        <td style="border: 1px solid black;"><?=$item["kelas"];?></td>
        <td style="border: 1px solid black;"><?=$item["jurusan"];?></td>
        <td style="border: 1px solid black;"><?=$item["no_tlp"];?></td>
        <td style="border: 1px solid black;"><?=$item["tgl_pendaftaran"];?></td>
