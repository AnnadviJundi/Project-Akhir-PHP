...
if(isset($_POST["agama"]) ) {
  $buku = queryReadData("SELECT * FROM buku WHERE kategori = 'agama'");
}
// read buku komik
     ...
     <div class="p-4 mt-5">
      ...
      <form action="" method="post">
        <div class="layout-card-custom">
         ...
         <button type="submit" name="agama" class="btn btn-outline-primary">Agama</button>
         <button type="submit" name="komik" class="btn btn-outline-primary">Komik</button>
         </div>
        </form>
       </div>
