  ...
  <div class="container p-5">
    <div class="d-flex justify-content-center">
      <div class="card" style="width: 30rem;">
        <img src="assets/Pustaka.png" class="card-img-top" alt="logo">
        <hr>
      ...
      <div class="card-body pt-2">
        ...
        <div class="row gap-2 p-2">
          <a class="btn btn-secondary" href="sign/admin/sign_in.php">Admin</a>
          <a class="btn btn-primary mb-2" href="sign/member/sign_in.php">Siswa</a>
        </div>
      </div>
      </div>
    </div>
